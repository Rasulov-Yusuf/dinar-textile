      ...
      <div className="container">
        <article className="bg-white rounded-[20px]">
          <div className="p-7 max-md:p-5">
            <h2 className="font-semibold text-4xl text-black pb-5 border-b border-[#E0E0E0] max-md:text-3xl max-sm:text-2xl">
              Biz haqimizda
            </h2>
            <div className="flex flex-col gap-y-6 pt-6">
              ...
              <div className="grid grid-cols-2 gap-x-4 pb-13 max-md:pb-5 max-md:grid-cols-1">
                <div className="flex flex-col pb-4 border-b border-[#E0E0E0] text-lg max-md:text-sm">
                ...
                <div className="flex flex-col pb-4 max-md:pt-4 border-b border-[#E0E0E0] text-lg max-md:text-sm">
                ...
                <div className="flex flex-col pt-4 max-md:pb-4 max-md:border-b max-md:border-[#E0E0E0] text-lg max-md:text-sm">
